...
export function getAllBackgrounds(state) {
    return state.allBackgrounds;
}

export function getAllAlignments(state) {
    return state.allAlignments;
}
